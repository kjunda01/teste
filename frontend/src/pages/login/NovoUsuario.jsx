        ...
        <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
          ...
          <div className="flex flex-col items-center text-center justify-center">
            <a href="https://unilavras.edu.br/0" target="_blank">
              <img src="https://novoportal.unilavras.edu.br/assets/svg/logo-full.svg" alt="" className="w-11 h-11" />
            </a>
          ...
          <h2 className="text-xl font-medium text-center mb-3">Novo Usuário</h2>
