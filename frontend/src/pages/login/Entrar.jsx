        ...
        <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
          ...
          <div className="flex flex-col items-center text-center justify-center">
            <a href="https://unilavras.edu.br/0" target="_blank">
              <img src="https://novoportal.unilavras.edu.br/assets/svg/logo-full.svg" alt="" className="w-15 h-15" />
            </a>
          ...
          <p className="text-center text-gray-600 mb-4">
            ...
            <a href="#" className="text-blue-500 hover:text-blue-950 text-xs">
          ...
          <form action="" className="space-y-4">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                <a href="#" className="text-sky-500 hover:text-blue-950">
                  Esqueceu sua senha?
                </a>
              </p>
            </div>
